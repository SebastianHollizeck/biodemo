...
Copyright   : (c) Sebastian Hollizeck, 29 Nov 2018 
License     : MIT 
Maintainer  : sebastian.hollizeck@petermac.org 
Portability : POSIX
...
def parse_args():
	...
	help='Maximum lentgh sequenuce to include in stats (default {})'.format(DEFAULT_MAX_LEN)
	)
